...
struct Recommendations: StaticPage {
    ...
    var body: some HTML {
        ...
        Text("Below is a semi-conclusive list of experiences I have enjoyed and would recommend. They're presented in the order in which they were consumed (not their release date).")

        Text("Books").font(.title3)
        List {
